<template>
  <div>
    ...
    <div id="my-container" style="height: 300px;background: url('https://t7.baidu.com/it/u=1595072465,3644073269&fm=193&f=GIF') no-repeat; background-size: cover;">
    </div>
    <div>
...
// DOM engine only
import Danmaku from '../lib/danmaku.dom.js'
...
export default {
  ...
  methods: {
    ...
    emitDanmu() {
      this.danmaku.emit({
        text: 'example' + Math.floor(Math.random() * 100),
